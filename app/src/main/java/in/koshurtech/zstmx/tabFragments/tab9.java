...
public class tab9 extends Fragment {
    ...
    List<displayInformation> displayInformationList = new ArrayList<>();


    public tab9(List<displayInformation> list){
        this.displayInformationList = list;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.displayInformationRecyclerView);
        swipeRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.displayInformationSRL);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if(recyclerInfoViewArrayList!=null){
                    ...
                    for(int i=0; i<displayInformationList.size(); i++){
                        recyclerInfoViewArrayList.add(new recyclerInfoView(displayInformationList.get(i).propertyBody,displayInformationList.get(i).propertyName));
