...
public class tab5 extends Fragment {
    ...
    public tab5(List<ramInformation> list){
        this.ramInformationArrayList = list;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.ramInformationRecyclerView);
        swipeRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.ramInformationSRL);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if(recyclerInfoViewArrayList!=null){
                    ...
                    for(int i=0; i<ramInformationArrayList.size(); i++){
                        recyclerInfoViewArrayList.add(new recyclerInfoView(ramInformationArrayList.get(i).propertyBody,ramInformationArrayList.get(i).propertyName));
